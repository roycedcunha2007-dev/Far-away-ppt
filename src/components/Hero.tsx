  ...
  return (
    <section className="relative h-full w-full flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="inline-block glass-panel px-4 py-1.5 rounded-full text-primary font-medium text-sm w-fit mx-auto lg:mx-0">
            ExamSphere Vision
          </div>
          ...
          <div className="flex gap-4 mt-4 justify-center lg:justify-start">
            <button className="px-8 py-4 bg-primary text-background font-bold rounded-full hover:shadow-[0_0_20px_rgba(0,229,255,0.5)] transition-all duration-300">
              View Live Demo
            </button>
            <button className="px-8 py-4 glass-panel text-white font-medium rounded-full hover:bg-white/10 transition-all duration-300">
